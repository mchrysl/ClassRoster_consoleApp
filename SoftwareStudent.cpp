...
int SoftwareStudent::getDegreeProgram() const {
	return degreeProgram;
}

SoftwareStudent::SoftwareStudent(const string inStudentID, const string inFirstName, const string inLastName, const string inEmailAddress, const int inAge,
